...
against the original Job 21641 outputs. The archive is a flat, minimal runtime
bundle: `./doitall.sh` and `./run-final` both run directly in the extracted
directory without a model `.conf`, selectivity CSV or any external file.
